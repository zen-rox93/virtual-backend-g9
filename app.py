...
#Esta variable se usa pra indicar en que ruta (endpoint) se encontrara la documentacion 
...
app = Flask(__name__)
#Los blueprints sirver para registrar en el caso que nosotros tengamos un proyecto interno y querramos agregarlo al proyecto principal de Flask
...
# headers : sirve para indicar que cabeceras puedem enviarse, x  defecto su valor es '*'
