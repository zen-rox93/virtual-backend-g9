...
class RecetasController(Resource):
    ...
    def post(self):
        ...
        self.serializador.add_argument(
            ...
            type=str,
            help='Fala la porcion {error_msg}' ,
            location='json'
        )
        
        
        data = self.serializador.parse_args()
        # implementar el guardado en la bd
        print(data)
        try:
...
class RecetaController(Resource):
    ...
    def get(self, id):
        ...
        for receta_ingrediente in receta.recetas_ingredientes:
            ...
            diccionario_receta_ingrediente['ingrediente'] = receta_ingrediente.recetaIngredienteIngredientes.__dict__
