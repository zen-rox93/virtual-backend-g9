class Electrodomestico:
    ...
    def __getNombre(self):
        """"El getter srive para devolver el valor del estributo privado"""
        return self.__nombre

    def __deleteNombre(self):
        """"El delter sirve para eliminar el contenido del atributo privado"""
        del self.__nombre

    # Property > sirve para definir el comportamiento que tendra un atrivuto de la clase
...
# print(objElectordomestico.nombre)