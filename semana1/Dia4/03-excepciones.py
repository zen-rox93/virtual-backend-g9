...
#Finally  : no importa si la operacion salio bien o hubo erroes, igual se ejecutara
# else : para usar el else tenemos que obligatoriamente declarar un except, y este se ejecutara cuando no ingresa a ningun except (cuadno la operacion no tuvo errores)
...
print("Los numeros son ñ {}".fornat(numeros))
