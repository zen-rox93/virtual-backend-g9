...
class PreparacionModel(base_de_datos.Model):
    ...
    # Delete => se eleminara y dejara a las FK con el mismo valor aunque este ya no exista
    # Restrinct => restrige y prohibe la eliminacion de las recetas que tengan preparaciones (primero tendremos que eliminar las preparaciones y luego recine a la receta)
