...
class RecetaModel(base_de_datos.Model):
    ...
    # y sus parametros:
    #backref : crear un atributo virtual en el otro modelo y sirve para que se pueda acceder a todo el objeto inverso
    # lazy : define como SQLAlchemy va a cargar la informacion adyacente de la basae de datos
    #True / 'select' : carga toda la informacion siempre
    # False / 'solamente cargara cuando sea necesario (cuando se vaya a usar los atributos auxiliares)
    # 'subquery' : trabajara con todos los datos PERO en forma de una sub consulta
